...
const DataCard = ({ label, value }: { label: string; value: number | string }) => (
  ...
  return (
    <DropdownSection title="Key Business Metrics">
      <div className="md:grid md:grid-cols-4 grid grid-cols-1 md:gap-4 gap-4">
        <DataCard label="Total Income (Year)" value={data.key_metrics.total_income_year} />
        <DataCard label="Total Expenses (Year)" value={data.key_metrics.total_expenses_year} />
        <DataCard label="Total Profit (Year)" value={data.key_metrics.total_profit_year} />
      ...
      <div className="md:grid md:grid-cols-4 grid grid-cols-1 md:gap-4 gap-4 mt-4">
        <DataCard label="Total Income (Month)" value={data.key_metrics.total_income_month} />
        <DataCard label="Total Expenses (Month)" value={data.key_metrics.total_expenses_month} />
...
const Header = () => {
  ...
  if (error) return <p className="p-6 text-red-500">Error: {(error as Error).message}</p>;
