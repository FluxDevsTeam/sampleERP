...
import { FaInstagram, FaTwitter, FaLinkedin, FaFacebook, FaTiktok } from "react-icons/fa";const Footer: React.FC = () => {
  const iconSize = 24;  return (
    <footer className="bg-gradient-to-b from-indigo-800 to-violet-800 text-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <h3 className="text-xl font-semibold text-white mb-4">FluxDevs ERP</h3>
        ...
        <div>
          ...
          <p className="text-indigo-100/90">Email: <a href="mailto:fluxdevs.company@gmail.com" className="hover:text-white transition">fluxdevs.company@gmail.com</a></p>
          <p className="text-indigo-100/90">Phone: +234 916 409 7582</p>
          <p className="text-indigo-100/90">WhatsApp: +234 916 409 7582</p>
      ...
      <div className="max-w-7xl mx-auto mt-8">
        ...
        <div className="flex justify-center gap-4">
          <a
            ...
            className="bg-white/10 text-white p-3 rounded-full hover:bg-white/20 transition border border-white/10"
          >
