...
const Income = () => {
  ...
  return (
    <div className="wrapper w-full mx-auto my-0 md:mb-2 mb-20 pt-2">
      <div className={`grid grid-cols-2 lg:grid-cols-6 gap-4 mb-2 mt-4 ${isTableModalOpen ? 'blur-md' : ''}`}>
      ...
      <div>
        <div className="grid grid-cols-2 items-center gap-2 mt-2 mb-2">
          ...
          <button className="flex items-center gap-2 px-4 py-2 border border-blue-400 text-blue-400 bg-transparent rounded hover:bg-blue-50 transition-colors text-xs sm:text-sm justify-self-end ml-auto sm:ml-0" onClick={() => setIsAddModalOpen(true)}>
